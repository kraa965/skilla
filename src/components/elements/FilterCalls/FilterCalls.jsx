    ...
    <div className="filter-calls__container">
      <div>
        <ul className="filter-calls__filters-list">
          <li className="filter-calls__filters-list-item" onClick={handleOpenTypes}>
            ...
            {isOpenTypes && (
              <ul className="filter-calls__filters-list-item-filter">
                <li className="filter-calls__filters-list-item-filter-item" onClick={resetFilters}>
                  Все типы
                </li>
                <li className="filter-calls__filters-list-item-filter-item" onClick={filterIncome}>
                  Входящие
                </li>
                <li className="filter-calls__filters-list-item-filter-item" onClick={filterOutCome}>
                  Исходящие
                </li>
              </ul>
            )}
          ...
          {isFilters && (
            <li className="filter-calls__filters-list-item" onClick={resetFilters}>
              <button className="filter-calls__filters-list-button">Сбросить фильтры</button>
